...
CREATE TABLE `movie` (
	...
	`mo_run`	int	NULL,
	`mo_opening_date`	date	NOT NULL,
	`mo_state`	varchar(10)	NULL,
	`mo_tr_num`	int NOT NULL
);
...
ALTER TABLE `movie` ADD CONSTRAINT `FK_trailer_TO_movie_1` FOREIGN KEY (
	`mo_tr_num`
)
REFERENCES `trailer` (
	`tr_num`
